...
function GalleryModal({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#C8A951]/20 via-black/90 to-[#C8A951]/20 pointer-events-none"></div>
      ...
      >
        ...
        <div className="absolute -inset-2 bg-gradient-to-r from-[#C8A951]/30 via-[#E0C370]/30 to-[#C8A951]/30 rounded-3xl blur-2xl opacity-50 pointer-events-none"></div>
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="relative group/image">
            {/* Sombra decorativa */}
            <div className="absolute -inset-4 bg-gradient-to-r from-[#C8A951]/20 via-transparent to-[#C8A951]/20 rounded-3xl blur-2xl opacity-0 group-hover/image:opacity-100 transition-opacity duration-500"></div>
