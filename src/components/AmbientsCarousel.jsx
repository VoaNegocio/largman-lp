    ...
    return (
        <section className="py-24 md:py-32 px-4 bg-gradient-to-br from-white via-neutral-50/30 via-blue-50/20 to-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute inset-0 opacity-[0.02]" style={{ backgroundImage: `linear-gradient(to right, #1B4B7B 1px, transparent 1px), linear-gradient(to bottom, #1B4B7B 1px, transparent 1px)`, backgroundSize: '50px 50px' }}></div>
